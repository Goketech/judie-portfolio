...
const DesignProcess = () => {
    return (
        <div className='max-w-screen-2xl xl:mx-auto mt-[100px]'>
            <p className='font-jarkata-sans mx-[22px] md:mx-[100px] text-[#FF5956]  text-[14px] leading-[18px]'>What we do</p>
            <h3 className='font-jarkata-sans mx-[22px] md:mx-[100px] text-[24px] md:text-[32px] leading-[36px] md:leading-[48px] mb-[40px] md:mb-[80px]'>Bringing Your Ideas to life with thoughtful design and user-focused solutions.</h3>
