    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center mt-[100px] mb-[100px]">
                ...
                <Link href="https://www.behance.net/gallery/193734369/ShopEasy-Fashion-made-effortless"><button className="bg-[#222222] transition-colors duration-300 hover:bg-transparent border border-white px-[16px] py-[12px] rounded-[300px] mt-[24px] text-[#FAFAFA]">view casestudy</button></Link>
            </div></>
    );
}
