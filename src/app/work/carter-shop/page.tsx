        ...
        <div className="mx-[100px]">
            ...
            <div className="flex flex-col items-center mt-[100px] gap-[40px]">
                <div className="border border-[#333333] p-[60px] rounded-[12px] transition-colors duration-300 hover:bg-[#333333]">
                    <Image src="/carter-shop-1.jpg" alt="letters-app" width={708} height={477} />
                </div>
                <div className="border border-[#333333] p-[60px] rounded-[12px] transition-colors duration-300 hover:bg-[#333333]">
                    <Image src="/carter-shop-2.jpg" alt="letters-app" width={708} height={477} />
                </div>
                <div className="border border-[#333333] p-[60px] rounded-[12px] transition-colors duration-300 hover:bg-[#333333]">
                    <Image src="/carter-shop-3.jpg" alt="letters-app" width={708} height={477} />
                </div>
                <div className="border border-[#333333] p-[60px] rounded-[12px] transition-colors duration-300 hover:bg-[#333333]">
                    <Image src="/carter-shop-4.jpg" alt="letters-app" width={708} height={477} />
                </div>
                <div className="border border-[#333333] p-[60px] rounded-[12px] transition-colors duration-300 hover:bg-[#333333]">
                    <Image src="/carter-shop-5.jpg" alt="letters-app" width={708} height={477} />
                </div>
            </div>
        </div>
    );
